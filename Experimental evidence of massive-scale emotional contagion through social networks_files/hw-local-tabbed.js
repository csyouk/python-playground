...
$(document).ready(function(){
	...
	var corrLink = $('.cb-views > .secondary-views li ul#content_box_errata li.errata');
	if (corrLink.length) {
		$('#content-block div.article div.contributors').first().after('<ul class="relmgr-links correction-list"></ul>');
