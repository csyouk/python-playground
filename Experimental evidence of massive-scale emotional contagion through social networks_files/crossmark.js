...
var crossmark = {
	...
	sCrossMarkServer: 'crossmark.crossref.org',
	sCDNServer: 'crossmark.crossref.org',
	...
	addStylesheet: function() {
		$(this.sOpenSelector).parent().eq(0).prepend("<link media='screen' rel='stylesheet' type='text/css' href='" + 'http://' + this.sStylesURL + "'/>");
		//$('head').append("<link media='screen' rel='stylesheet' type='text/css' href='" + 'http://' + this.sStylesURL + "'/>");
	},
